...
if (!methodCodeQR && !methodCode && !fs.existsSync(`./${authFile}/creds.json`)) {
    do {
        ...
        const a = color1('╭━━━━━━━━━━━━━• ✧˚💎 𝐒𝐂𝚯𝐑𝐏𝐈𝚯𝚴 💠˚✧ •━━━━━━━━━━━━━');
        const b = color1('╰━━━━━━━━━━━━━• ☾⋆₊✧ 𝐒𝐂𝚯𝐑𝐏𝐈𝚯𝚴 ✧₊⋆☽ •━━━━━━━━━━━━━');
        const linea = color2('   ✦━━━━━━✦✦━━━━━━༺💧༻━━━━━━༺💧༻━━━━━━✦✦━━━━━━✦');
        ...
        const istruzioni = [
            ...
            softText.italic(''),
            color1.italic('                   developed by blood'),
        ];
...
if (!fs.existsSync(`./${authFile}/creds.json`)) {
    if (opzione === '2' || methodCode) {
        ...
        if (!conn.authState.creds.registered) {
            ...
            setTimeout(async () => {
                let codeBot = await conn.requestPairingCode(addNumber, 'SCORPION');
...
async function connectSubBots() {
    ...
    if (!existsSync(subBotDirectory)) {
        console.log(chalk.bold.hex('#00D2FF')('💠 𝐒𝐂𝚯𝐑𝐏𝐈𝚯𝚴 : Nessun Sub-Bot trovato.'));
        try {
